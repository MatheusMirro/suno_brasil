            ...
            <div className="flex justify-center ml-12">
                ...
                <div className="flex flex-col">
                    <div className="flex flex-row items-center gap-8 my-2 ">
                        <img className="w-[30%]" src="SUNOTECH.svg" alt="Círculo Amarelo"></img>
                        <p className="text-suno-dark-blue text-xl">
                    ...
                    <div className="flex flex-row items-center gap-8 my-2 ">
                        <img className="w-[30%]" src="SUNOSTAFFING.svg" alt="Círculo Amarelo"></img>
                        <p className="text-suno-dark-blue text-xl">
                    ...
                    <div className="flex flex-row items-center gap-8 my-2 ">
                        <img className="w-[30%]" src="SUNORPO.svg" alt="Círculo Amarelo"></img>
                        <p className="text-suno-dark-blue text-xl">
