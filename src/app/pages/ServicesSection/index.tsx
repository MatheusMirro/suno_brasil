    ...
    return (
        <div className="h-full bg-suno-gray md:p-10">
            <div className="flex justify-center md:ml-12 min-[320px]:max-md:flex-col">
                ...
                <div className="flex flex-col min-[320px]:max-md:text-center min-[320px]:max-md:mt-10">
                    <div className="flex md:flex-row items-center gap-8 md:my-2 min-[320px]:max-md:m-auto min-[320px]:max-md:flex-col min-[320px]:max-md:w-[60%] min-[320px]:max-md:my-5">
