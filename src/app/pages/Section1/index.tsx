    ...
    return (
        <div className="relative w-full">
            <div id="about" className="flex flex-col items-center justify-center bg-suno-gray">
                <h1 className="schibsted min-[320px]:max-lg:text-4xl text-5xl text-center text-suno-dark-blue my-9 font-extrabold">
                    Somos uma consultoria <br/>
                    de recrutamento & seleção, <br/>
                    que conecta as pessoas certas <br/>
                    às melhores oportunidades, <br/>
                    impulsionando carreiras e resultados.

                </h1>
                <button className="min-[320px]:max-[519px]:relative w-80 h-11 absolute lg:mb-[25%] xl:mb-[10%] bg-suno-acqua rounded-3xl text-suno-dark-blue schibsted-bold z-10 md:mb-[30%] min-[520px]:max-[770px]:mb-[40%]">FALE COM UM ESPECIALISTA</button>
                ...
                <div className="min-[320px]:max-[519px]:relative min-[520px]:max-[560px]:relative min-[520px]:max-[560px]:z-10 bg-white absolute lg:w-full lg:p-10 md:mt-[40%] lg:mt-[35%] xl:mt-[22%] min-[2500px]:mt-[12%] min-[320px]:max-[770px]:mt-[25%]">
